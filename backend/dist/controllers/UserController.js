...
const userController = {
    ...
    async getByToken(req, res, next) {
        try {
            ...
            if (!decodedToken._id) {
                throw errorMessages.push((0, Error_1.default)("The token provided is invalid.", 401, "TOKEN_INVALID"));
            }
            const user = User_2.default.findById(decodedToken._id);
            if (!user) {
                throw errorMessages.push((0, Error_1.default)("The user could not be found with this token.", 404, "USER_NOT_FOUND"));
            }
    ...
    async getAllUsers(req, res, next) {
        try {
            ...
            if (!users || users.length === 0) {
                throw errorMessages.push((0, Error_1.default)("There was no user found.", 404, "NO_USER_FOUND"));
            }
    ...
    async getUserById(req, res, next) {
        try {
            ...
            // Validation
            if (!user) {
                throw errorMessages.push((0, Error_1.default)("The id provided dit not match any user", 404, "USER_NOT_FOUND"));
            }
    ...
    async deleteUser(req, res, next) {
        try {
            ...
            // Admin validation
            if (user.role != 'admin') {
                throw errorMessages.push((0, Error_1.default)("You do not have the rights to delete a user.", 404, "RIGHTS_ERROR"));
            }
